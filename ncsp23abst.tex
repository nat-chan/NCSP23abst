...
\mytd{examples/synth/seed3337.png} & \mytd{examples/synth/seed2061.png} & \mytd{examples/sim/seed2061.png} & \mytd{grid100ref/dist_weight=0.3_additional_weight=0.7_custom_lr=0.05_w_std=0.7/48.png} & \mytd{examples/sim_synth/2061_3337.png} & \mytd{examples/pair50/48/a.png} & \mytd{examples/petalica/t48.jpg} & \mytd{examples/petalica/s48.jpg} & \mytd{examples/petalica/c48.jpg} & \mytd{examples/webtoon/48_ai-painter.png} & \mytd{examples/clipstudio/48.png} \\ \hline
